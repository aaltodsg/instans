...
(define-class instans ()
  ((name :accessor instans-name :initarg :name)
   ...
   (triple-input-policy :accessor instans-triple-input-policy :initarg :triple-input-policy :initform :repeat-first)
   (triple-processing-policy :accessor instans-triple-processing-policy :initarg :triple-processing-policy :initform :repeat-first)
   (rule-instance-removal-policy :accessor instans-rule-instance-removal-policy :initform nil :initarg :rule-instance-removal-policy)
   (rule-execution-policy :accessor instans-rule-execution-policy :initarg :rule-execution-policy :initform :repeat-first)
