...
(defgeneric aggregate-get-value (aggregate)
  ...
  (:method ((this aggregate-min))
    (cond ((null (aggregate-history this))
	   (error* "Trying to find minimum of an empty group ~A" this))
	  (t
	   (first (aggregate-history this)))))
  (:method ((this aggregate-max))
    (cond ((null (aggregate-history this))
	   (error* "Trying to find maximum of an empty group ~A" this))
	  (t
	   (first (aggregate-history this)))))
  (:method ((this aggregate-sample))
    (cond ((null (aggregate-history this))
	   (error* "Trying to find sample of an empty group ~A" this))
	  (t
	   (first (aggregate-history this)))))
...
(defgeneric aggregate-add-value (aggregate new-value)
  ...
  (:method ((this aggregate-sum) new-value) (incf (aggregate-sum this) new-value))
  (:method ((this aggregate-avg) new-value) (incf (aggregate-count this)) (incf (aggregate-sum this) new-value))
...
(defgeneric aggregate-remove-value (aggregate value)
  ...
  (:method ((this aggregate-sum) value) (decf (aggregate-sum this) value))
  (:method ((this aggregate-avg) value) (decf (aggregate-count this)) (decf (aggregate-sum this) value))
