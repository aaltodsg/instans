...
(define-class instans ()
  ((name :accessor instans-name :initarg :name)
   ...
   (token-stores :accessor instans-token-stores :initform nil)
   (token-indices :accessor instans-token-indices :initform nil)
   (token-maps :accessor instans-token-maps :initform nil)
...
;   (allowed-rule-instance-removal-policies :accessor instans-allowed-rule-instance-removal-policies :allocation :class :initform '(:remove :keep))
   ...
   (ask-output-name :accessor instans-ask-output-name :initform nil)
   (ask-output-type :accessor instans-ask-output-type :initform :ttl)
   (ask-output-append-p :accessor instans-ask-output-append-p :initform nil)
   (base :accessor instans-base :initarg :base :initform nil)
   (graph :accessor instans-graph :initarg :graph :initform nil)
   (select-output-name :accessor instans-select-output-name :initform "-")
   (select-output-type :accessor instans-select-output-type :initform :csv)
   (select-output-append-p :accessor instans-select-output-append-p :initform nil)
   (construct-output-name :accessor instans-construct-output-name :initform "-")
   (construct-output-type :accessor instans-construct-output-type :initform :trig)
   (construct-output-append-p :accessor instans-construct-output-append-p :initform nil)
