...
(define-sparql-function "=" (:arguments ((a term-or-value-or-group) (b term-or-value-or-group)) :returns xsd-boolean-value)
...
;;; Aggregates
(define-sparql-function "aggregate" (:arguments ((g group) (index xsd-integer-value)) :returns xsd-value :hiddenp t)
  (:method ((g group) (index xsd-integer-value))
    (aggregate-get-value (nth index (group-aggregates g)))))
