...
(defun hashable-key (term)
  (cond ((typep term 'rdf-iri)
	 (rdf-iri-string term))
	((typep term 'uniquely-named-object)
	 (uniquely-named-object-name term))
	((typep term 'rdf-literal)
	 (list (rdf-literal-string term) (rdf-literal-lang term) (and (rdf-literal-type term) (rdf-iri-string (rdf-literal-type term)))))
	(t term)))
