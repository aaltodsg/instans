...
(defgeneric run-input-processor (instans-input-processor)
  ...
  (:method ((this instans-stream-input-processor))
    (let* ((instans (instans-input-processor-instans this))
	   (*instans* instans)
	   (ll-parser (parse (instans-stream-input-processor-parser this))))
      (declare (special *instans*))
...
;    (handler-case 
	(progn
	  (loop for ip in (instans-input-processors this)
		do (cond ((instans-lisp-input-processor-p ip)
			  (close (rdf-lisp-parser-stream (instans-stream-input-processor-parser ip))))
			 ((instans-stream-input-processor-p ip)
