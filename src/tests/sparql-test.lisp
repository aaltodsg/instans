...
(defgeneric sparql-test-add-graphs (sparql-test2)
  (:method ((this sparql-update-evaluation-test))
    (loop for datafile in (sparql-test-graphfiles this)
	  ...
	  do (instans-add-stream-input-processor (sparql-test-instans this) datafile :base (sparql-test-base this) :input-type file-type))))

(defgeneric sparql-test-add-inputs (sparql-test2)
  (:method ((this sparql-update-evaluation-test))
    (call-next-method)
    (sparql-test-add-graphs this))
  (:method ((this sparql-query-evaluation-test))
