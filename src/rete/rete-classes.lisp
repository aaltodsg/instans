...
(define-class instans ()
  ((name :accessor instans-name :initarg :name)
   ...
   (sparql-var-factory :accessor instans-sparql-var-factory)
   (rdf-anonymous-blank-node-factory :accessor instans-rdf-anonymous-blank-node-factory)
   (rdf-named-blank-node-factory :accessor instans-rdf-named-blank-node-factory)
