...
;   (allowed-rule-instance-removal-policies :accessor instans-allowed-rule-instance-removal-policies :allocation :class :initform '(:remove :keep))
   ...
   (ask-output-type :accessor instans-ask-output-type :initform nil)
   (base :accessor instans-base :initarg :base)
   (graph :accessor instans-graph :initarg :graph)
   (select-output-name :accessor instans-select-output-name :initform nil)
   (select-output-type :accessor instans-select-output-type :initform nil)
   (select-output-append-p :accessor instans-select-output-append-p :initform nil)
   (construct-output-name :accessor instans-construct-output-name :initform nil)
   (construct-output-type :accessor instans-construct-output-type :initform nil)
